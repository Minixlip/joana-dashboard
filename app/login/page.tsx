      ...
      >
        <div className="bg-secondary-background shadow-2xl rounded-xl p-8 sm:p-10">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-accent font-serif">Dashboard Login</h1>
            <p className="text-primary-text/70 mt-2">Access your content management panel.</p>
          </div>

          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-primary-text/80 mb-1.5">
                Email address
              </label>
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-primary-text/80 mb-1.5">
                Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            ...
            {error && (
              <p className="text-sm text-red-400 bg-red-500/10 p-3 rounded-md text-center">{error}</p>
            )}
         ...
         <p className="mt-8 text-center text-sm text-primary-text/60">
            This is a restricted area. Public site: <Link href="/" className="font-medium text-accent hover:underline">Go to Portfolio</Link>
        </p>
      </motion.div>
    </div>
  );
